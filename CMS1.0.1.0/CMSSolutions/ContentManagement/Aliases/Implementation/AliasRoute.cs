...
namespace CMSSolutions.ContentManagement.Aliases.Implementation
{
    ...
    public class AliasRoute : RouteBase, IRouteWithArea
    {
        ...
        {
            Area = areaName;
            aliasMap = aliasHolder.GetMap(areaName);
        ...
        public override RouteData GetRouteData(HttpContextBase httpContext)
        {
            ...
            if (aliasMap.TryGetAlias(virtualPath, out routeValues))
            {
        ...
        public override VirtualPathData GetVirtualPath(RequestContext requestContext, RouteValueDictionary routeValues)
        {
            ...
            var match = aliasMap.Locate(routeValues);
            if (match != null)
            {
