...
namespace CMSSolutions.Environment
{
    ...
    public class HostComponentsConfigModule : Module
    {
        ...
        private readonly IDictionary<string, IEnumerable<PropertyEntry>> config = new Dictionary<string, IEnumerable<PropertyEntry>>();
        ...
        public HostComponentsConfigModule(string fileName)
        {
            ...
            foreach (var component in doc.Elements(XNames.HostComponents).Elements(XNames.Components).Elements(XNames.Component))
            {
                ...
                config.Add(componentType, properties);
            }
        }
        ...
        protected override void AttachToComponentRegistration(IComponentRegistry componentRegistry, IComponentRegistration registration)
        {
            ...
            if (!config.TryGetValue(implementationType.FullName, out properties))
                return;
