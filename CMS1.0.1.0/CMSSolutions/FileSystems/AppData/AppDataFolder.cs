...
namespace CMSSolutions.FileSystems.AppData
{
    ...
    {
        private readonly IAppDataFolderRoot root;
        ...
        private void MakeDestinationFileNameAvailable(string destinationFileName)
        {
            ...
            {
                Logger.WarnFormat("Could not delete recipe execution folder {0} under \"App_Data\" folder", destinationFileName);
                return;
            }
            ...
            {
                throw new CMSException(T("Unable to make room for file \"{0}\" in \"App_Data\" folder", destinationFileName), e);
            }
        }
        ...
        {
            Logger.InfoFormat("Storing file \"{0}\" as \"{1}\" in \"App_Data\" folder", sourceFileName, destinationPath);
        ...
        {
            Logger.InfoFormat("Deleting file \"{0}\" from \"App_Data\" folder", path);
