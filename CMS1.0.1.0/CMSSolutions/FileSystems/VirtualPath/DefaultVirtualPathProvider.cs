    ...
    public class DefaultVirtualPathProvider : IVirtualPathProvider
    {
        ...
        public virtual string ToAppRelative(string virtualPath)
        {
            ...
            catch (Exception e)
            {
                ...
                Logger.InfoFormat(e, "Path '{0}' cannot be made app relative", virtualPath);
                return null;
            }
        }
        ...
        public virtual bool TryFileExists(string virtualPath)
        {
            ...
            {
                Logger.InfoFormat(e, "File '{0}' can not be checked for existence. Assuming doesn't exist.", virtualPath);
                return false;
            }
        }
