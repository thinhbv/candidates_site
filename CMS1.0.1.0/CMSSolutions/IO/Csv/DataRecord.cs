...
namespace VortexSoft.MvcCornerstone.IO.Csv
{
    /// <summary>
    ...
    public sealed class DataRecord : RecordBase
    {
        ...
        public string this[string column]
        {
            get
            {
                ...
                {
                    throw new InvalidOperationException("No header record has been set for this CsvReader.");
                }

                return Values[headerRecord[column]];
            }
        }
        ...
        public string GetValueOrNull(string column)
        {
            ...
            return GetValueOrNull(headerRecord.IndexOf(column));
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            if ((headerRecord == null) && (record.headerRecord == null))
            {
                //both have no header and equal values, therefore they are equal
                return true;
            }

            if (((headerRecord != null) && (record.headerRecord != null)) && (headerRecord.Equals(record.headerRecord)))
            {
        ...
        public override int GetHashCode()
        {
            ...
            if (headerRecord != null)
            {
                retVal = (int)Math.Pow(retVal, headerRecord.GetHashCode());
            }
