...
using CMSSolutions.Net.Mail.Common;
using CMSSolutions.Net.Mail.Mime.Decode;

namespace CMSSolutions.Net.Mail.Mime.Header
{
    /// <summary>
    ...
    public class RfcMailAddress
    {
        ...
        /// <br/>
        /// Examples of input:
        /// <c>Eksperten mailcontrolt &lt;noreply@mail.eksperten.dk&gt;</c><br/>
        /// <c>"Eksperten mailcontrolt" &lt;noreply@mail.eksperten.dk&gt;</c><br/>
        ...
        internal static RfcMailAddress ParseMailAddress(string input)
        {
            ...
            catch (FormatException)
            {
                ...
                throw new ArgumentException("RfcMailAddress: Improper mail address: \"" + input + "\"", "input");
            }

            // It could be that the format used was simply a name
            // which is indeed valid according to the RFC
            // Example:
            // Eksperten mailcontrolt
        ...
        internal static List<RfcMailAddress> ParseMailAddresses(string input)
        {
            ...
            IEnumerable<string> mailAddresses = StringUtility.SplitStringWithCharNotInsideQuotes(input, ',');
