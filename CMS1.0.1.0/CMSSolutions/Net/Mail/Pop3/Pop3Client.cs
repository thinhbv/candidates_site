...
using CMSSolutions.Net.Mail.Mime;
using CMSSolutions.Net.Mail.Mime.Header;
using CMSSolutions.Net.Mail.Pop3.Exceptions;

namespace CMSSolutions.Net.Mail.Pop3
{
    /// <summary>
    ...
    public class Pop3Client : Disposable
    {
        ...
        #endregion Connection managing methods
        ...
        #endregion Public POP3 commands
