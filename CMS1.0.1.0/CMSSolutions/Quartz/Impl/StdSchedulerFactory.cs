...
using NLog;
using CMSSolutions.Quartz.Core;
using CMSSolutions.Quartz.Impl.Matchers;
using CMSSolutions.Quartz.Simpl;
using CMSSolutions.Quartz.Spi;
using CMSSolutions.Quartz.Util;

namespace CMSSolutions.Quartz.Impl
{
    /// <summary>
    ...
    public class StdSchedulerFactory : ISchedulerFactory
    {
        ...
        private static readonly Logger log = LogManager.GetLogger(typeof(StdSchedulerFactory).FullName);
        ...
        public void Initialize()
        {
            ...
            if (props == null)
            {
                ...
                try
                {
                    PropertiesParser pp = PropertiesParser.ReadFromEmbeddedAssemblyResource("CMSSolutions.Quartz.quartz.config");
                    props = pp.UnderlyingProperties;
