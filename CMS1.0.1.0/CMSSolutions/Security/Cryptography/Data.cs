...
namespace CMSSolutions.Security.Cryptography
{
    ...
    public class Data
    {
        ...
        public string Hex
        {
            get { return EncryptionExtensions.ToHex(_b); }
            set { _b = EncryptionExtensions.FromHex(value); }
        }
        ...
        {
            get { return EncryptionExtensions.ToBase64(_b); }
            set { _b = EncryptionExtensions.FromBase64(value); }
        }
