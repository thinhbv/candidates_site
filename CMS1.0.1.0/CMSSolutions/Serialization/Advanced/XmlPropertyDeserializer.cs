...
namespace CMSSolutions.Serialization.Advanced
{
    ...
    public sealed class XmlPropertyDeserializer : IPropertyDeserializer
    {
        ...
        #endregion IPropertyDeserializer Members
        ...
        {
            // ElementType
            property.ElementType = property.Type != null ? Serialization.Serializing.TypeInfo.GetTypeInfo(property.Type).ElementType : null;
        ...
        private void parseDictionaryProperty(DictionaryProperty property)
        {
            ...
            {
                var typeInfo = Serialization.Serializing.TypeInfo.GetTypeInfo(property.Type);
