...
using System.Text;
using System.Xml;
using CMSSolutions.Serialization.Advanced;
using CMSSolutions.Serialization.Advanced.Deserializing;
...
using CMSSolutions.Serialization.Deserializing;
using CMSSolutions.Serialization.Serializing;

namespace CMSSolutions.Serialization
{
    /// <summary>
    ...
    public sealed class SharpSerializer
    {
        ...
        private void initialize(SharpSerializerBinarySettings settings)
        {
            ...
            // Create Serializer and Deserializer
            Serialization.Advanced.Binary.IBinaryReader reader = null;
            Serialization.Advanced.Binary.IBinaryWriter writer = null;
        ...
        private static void CreateDirectoryIfNeccessary(string filename)
        {
        ...
        /// <summary>
        ///   Deserializing from the string value.
        /// </summary>
        ...
        #endregion Serializing/Deserializing methods
    }
}