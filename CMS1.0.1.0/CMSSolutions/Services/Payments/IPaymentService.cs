...
namespace VortexSoft.MvcCornerStone.Services.Payments
{
    ...
    public interface IPaymentService
    {
        ...
        IPaymentMethod LoadPaymentMethodByName(string systemName);
        ...
        bool CanRePostProcessPayment(IOrder order);
        ...
        decimal GetAdditionalHandlingFee(string paymentMethodName);
        ...
        bool SupportCapture(string paymentMethodName);
        ...
        bool SupportPartiallyRefund(string paymentMethodName);
        ...
        bool SupportRefund(string paymentMethodName);
        ...
        bool SupportVoid(string paymentMethodName);
        ...
        RecurringPaymentType GetRecurringPaymentType(string paymentMethodName);
        ...
        PaymentMethodType GetPaymentMethodType(string paymentMethodName);
