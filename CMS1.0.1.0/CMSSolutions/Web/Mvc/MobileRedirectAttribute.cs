...
namespace CMSSolutions.Web.Mvc
{
    ...
    {
        public MobileRedirectAttribute(string url)
        {
            Url = url;
        }
        ...
        {
            var u = filterContext.RequestContext.HttpContext.Request.ServerVariables["HTTP_USER_AGENT"];
            ...
            if ((b.IsMatch(u) || v.IsMatch(u.Substring(0, 4))) && !filterContext.HttpContext.Request.Url.ToString().StartsWith(Url))
