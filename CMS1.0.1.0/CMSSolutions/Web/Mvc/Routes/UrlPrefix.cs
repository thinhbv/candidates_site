...
namespace CMSSolutions.Web.Mvc.Routes
{
    ...
    public class UrlPrefix
    {
        ...
        {
            this.prefix = prefix.TrimStart('~').Trim('/');
        }
        ...
        public string RemoveLeadingSegments(string path)
        {
            ...
            var endIndex = beginIndex + prefix.Length;
            ...
            if (string.Compare(path, beginIndex, prefix, 0, prefix.Length, StringComparison.OrdinalIgnoreCase) == 0)
            {
