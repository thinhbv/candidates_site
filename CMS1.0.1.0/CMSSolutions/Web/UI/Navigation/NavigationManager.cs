...
namespace CMSSolutions.Web.UI.Navigation
{
    public class NavigationManager : INavigationManager
    {
        ...
        public NavigationManager(IEnumerable<INavigationProvider> providers, UrlHelper urlHelper, IHttpContextAccessor httpContextAccessor, IWorkContextAccessor workContextAccessor, IAuthorizationService authorizationService = null)
        {
        ...
        public IList<MenuItem> BuildMenu()
        {
        ...
        private IList<MenuItem> FinishMenu(IList<MenuItem> menuItems, string currentUrl)
        {
        ...
        private IEnumerable<MenuItem> Reduce(IEnumerable<MenuItem> items, WorkContext workContext)
        {
        ...
        private static MenuItem Join(IList<MenuItem> items)
        {
            if (items.Count() < 2)
                return items.Single();
