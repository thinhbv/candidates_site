namespace CMSSolutions.Websites.Entities
{
    ...
    [DataContract()]
    public class Stakeholder : BaseEntity<int>
    {
    ...
    public class StakeholderMapping : EntityTypeConfiguration<Stakeholder>, IEntityTypeConfiguration
    {
        
        public StakeholderMapping()
        {
            this.ToTable("Module_Stakeholder");
            this.HasKey(m => m.Id);
